...
<head>
    ...
    <title>تأكيد البريد الإلكتروني - Bedoon Quyood</title>
    <style>
...
<div class="container">
    <div class="card">
        ...
        <div class="content">
            ...
            <div class="box">
                <p style="margin:0;">إذا لم تكن أنت من قام بالتسجيل في Bedoon Quyood، يمكنك تجاهل هذه الرسالة بأمان.</p>
            </div>
        ...
        <div class="footer">
            © {{ date('Y') }} Bedoon Quyood. جميع الحقوق محفوظة.
        </div>
    </div>
</div>
</body>
