...
<head>
    ...
    <style>
        ...
        .brand-inner { width: 64px; height: 64px; background: linear-gradient(135deg, #DB8A47 0%, #E8935B 100%); border-radius: 18px; display: flex; align-items: center; justify-content: center; box-shadow: 0 12px 30px rgba(219,138,71,0.25); margin: 0 auto; }
