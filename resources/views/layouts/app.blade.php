...
<head>
    ...
    <meta property="og:image" content="{{ asset('assets/images/logo.png') . '?v=3' }}">
...
<body class="bg-gray-50 text-right">
    ...
    <nav x-data="{ mobileNavOpen: false, scrolled: false }" x-init="window.addEventListener('scroll', () => scrolled = window.scrollY > 20)"
        ...
        <a href="/" class="flex items-center gap-2">
            <img src="{{ asset('assets/images/logo-icon.png') . '?v=2' }}" alt="Orbit Logo" class="h-12 w-12 rounded-full object-cover transition-transform duration-300 hover:scale-105">
...
@auth
    ...
    <footer class="bg-navy-950 text-white py-12 px-8 mt-20">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8 max-w-7xl mx-auto">
            <div>
                <img src="{{ asset('assets/images/logo-icon.png') . '?v=2' }}" alt="Logo" class="h-12 w-12 rounded-full object-cover mb-6"> 
