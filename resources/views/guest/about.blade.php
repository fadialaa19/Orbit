...
<section class="py-20 px-4 md:px-8 max-w-7xl mx-auto">
    ...
    <div class="text-center mb-24" data-aos="fade-down">
        ...
        <h1 class="text-5xl md:text-6xl font-black text-slate-900 mb-6 leading-tight">Orbit <span class="grad-text">تحقق</span> حلمك الدراسي</h1>
    ...
    <div class="mb-24">
        ...
        <div class="relative">
            <!-- Timeline Line -->
            <div class="absolute left-1/2 transform -translate-x-1/2 top-32 md:top-48 h-px w-16 md:w-96 bg-gradient-to-r from-gold-400 to-gold-600 shadow-lg hidden md:block"></div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-16 items-stretch">
                ...
                <div class="group relative z-10" data-aos="fade-up" data-aos-delay="200">
                    <div class="w-32 h-32 bg-gradient-to-br from-navy-800 to-navy-900 text-white rounded-[3rem] flex flex-col items-center justify-center mx-auto font-black text-2xl shadow-2xl border-8 border-white mb-8 transform group-hover:scale-110 group-hover:rotate-6 transition-all duration-700">
                        02
                        <span class="text-sm mt-1 block font-bold">مطابقة</span>
                    </div>
                    <div class="bg-gradient-to-br from-gold-100 to-cream-50 rounded-[2.5rem] p-10 shadow-2xl border-4 border-white hover:shadow-3xl hover:-translate-y-6 transition-all duration-500 relative backdrop-blur-sm">
    ...
    <!-- CTA -->
    <div class="text-center py-20 bg-gradient-to-br from-navy-900 via-navy-800 to-gold-600 rounded-[2.5rem] text-white shadow-2xl px-8" data-aos="zoom-in-up">
