...
<head>
    ...
    <title>إنشاء حساب جديد - Bedoon Quyood</title>
...
<body class="bg-slate-50 min-h-screen flex items-center justify-center p-4">
    ...
    <div class="max-w-xl w-full" 
        ...
        <div class="flex justify-end mb-4">
            <a href="/" class="flex items-center gap-2 text-slate-500 hover:text-indigo-600 font-bold transition">
        ...
        <div class="bg-white rounded-[2.5rem] shadow-2xl p-8 md:p-12 border border-slate-50 relative">
            ...
            <form action="{{ route('register') }}" method="POST" @submit="if (step < 3) { $event.preventDefault(); goNext(); }">
                ...
                <div x-show="step === 1" x-cloak x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 translate-x-10">
                    <h2 class="font-black text-slate-800 mb-6 border-r-4 border-indigo-600 pr-3">المعلومات الأساسية</h2>
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <input type="text" name="name" x-model="name" placeholder="أحمد محمد" 
                                ...
                                :class="(errors.name || serverErrors.name) ? 'border-rose-500' : 'border-transparent focus:border-indigo-500 focus:bg-white'">
                        ...
                        <div>
                            ...
                            <input type="email" name="email" x-model="email" placeholder="your.email@example.com" 
                                ...
                                :class="(errors.email || serverErrors.email) ? 'border-rose-500' : 'border-transparent focus:border-indigo-500 focus:bg-white'">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="password" name="password" x-model="password" placeholder="••••••••" 
                                    class="w-full bg-slate-50 border-2 rounded-xl py-3 px-5 outline-none transition-all text-left" dir="ltr"
                                    :class="(errors.password || serverErrors.password) ? 'border-rose-500' : 'border-transparent focus:border-indigo-500 focus:bg-white'">
                            ...
                            <div>
                                ...
                                <input type="password" name="password_confirmation" x-model="password_confirmation" placeholder="••••••••" 
                                    class="w-full bg-slate-50 border-2 rounded-xl py-3 px-5 outline-none transition-all text-left" dir="ltr"
                                    :class="(errors.password_confirmation || serverErrors.password_confirmation) ? 'border-rose-500' : 'border-transparent focus:border-indigo-500 focus:bg-white'">
                    ...
                    <div class="mt-10">
                        <button type="button" @click="goNext()" class="w-full grad-bg text-white py-4 rounded-2xl font-black shadow-xl shadow-indigo-100 hover:scale-[1.02] transition">
                            التالي
                        </button>
                    </div>
                </div>
                ...
                <div x-show="step === 2" x-cloak x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 translate-x-10">
                    <h2 class="font-black text-slate-800 mb-6 border-r-4 border-indigo-600 pr-3">التفاصيل الأكاديمية</h2>
                    ...
                    <div class="space-y-5">
                        <div>
                            ...
                            <input type="text" name="country" x-model="country" placeholder="السعودية" 
                                class="w-full bg-slate-50 border-2 rounded-xl py-3 px-5 outline-none transition-all"
                                :class="(errors.country || serverErrors.country) ? 'border-rose-500' : 'border-transparent focus:border-indigo-500 focus:bg-white'">
                        ...
                        <div>
                            ...
                            <input type="text" name="field" x-model="field" placeholder="علوم الحاسب" 
                                class="w-full bg-slate-50 border-2 border-transparent focus:border-indigo-500 focus:bg-white rounded-xl py-3 px-5 outline-none transition-all">
                        </div>
                    </div>
                    ...
                    <div class="mt-10 flex gap-4">
                        ...
                        <button type="button" @click="goNext()" class="flex-[2] grad-bg text-white py-4 rounded-2xl font-black shadow-xl shadow-indigo-100 hover:scale-[1.02] transition">
                            التالي
                        </button>
                    </div>
                </div>
                ...
                <div x-show="step === 3" x-cloak x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 translate-x-10">
                    ...
                    <div class="mt-10 flex gap-4">
                        ...
                        <button type="submit" class="flex-[2] grad-bg text-white py-4 rounded-2xl font-black shadow-xl shadow-indigo-100 hover:scale-[1.02] transition">
                            إنهاء التسجيل
                        </button>
                    </div>
                </div>
