        ...
        <div class="bg-white rounded-[2.5rem] shadow-2xl shadow-indigo-100/50 p-10 border border-slate-50 relative overflow-hidden">
            ...
            <form action="{{ route('password.update') }}" method="POST" class="space-y-6">
                ...
                <div>
                    ...
                    <div class="relative">
                        <input type="email" name="email" value="{{ old('email', $email) }}" placeholder="your.email@example.com" class="w-full bg-slate-50 border-2 border-transparent focus:border-indigo-500 focus:bg-white rounded-2xl py-4 px-6 outline-none transition-all font-medium text-left" dir="ltr">
                    </div>
                    @error('email')
                ...
                <div>
                    ...
                    <input type="password" name="password_confirmation" placeholder="••••••••" class="w-full bg-slate-50 border-2 border-transparent focus:border-indigo-500 focus:bg-white rounded-2xl py-4 px-6 outline-none transition-all font-medium text-left" dir="ltr">
                </div>
