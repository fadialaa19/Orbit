                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                                ...
                                <div>
                                    ...
                                    <div class="relative" x-data="{ pwShow: false }">
                                        <input type="password" :type="pwShow ? 'text' : 'password'" name="current_password" placeholder="مطلوبة فقط عند تغيير كلمة المرور" class="w-full bg-slate-50 border-0 rounded-2xl py-5 pl-5 pr-14 text-slate-700 font-bold focus:ring-2 focus:ring-gold-500">
                                ...
                                <div>
                                    ...
                                    <div class="relative" x-data="{ pwShow: false }">
                                        <input type="password" :type="pwShow ? 'text' : 'password'" name="new_password" placeholder="اترك فارغاً لعدم التغيير" class="w-full bg-slate-50 border-0 rounded-2xl py-5 pl-5 pr-14 text-slate-700 font-bold focus:ring-2 focus:ring-gold-500">
                                        <button type="button" @click="pwShow = !pwShow" tabindex="-1" class="absolute inset-y-0 right-4 flex items-center text-slate-300 hover:text-gold-600 transition-colors">
                                            <svg x-show="!pwShow" x-transition:enter="transition duration-500 [transition-timing-function:cubic-bezier(.68,-0.55,.27,1.55)]" x-transition:enter-start="opacity-0 scale-0 rotate-180" x-transition:enter-end="opacity-100 scale-100 rotate-0" class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"></path>
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"></path>
                                ...
                                <div class="md:col-span-2">
                                    ...
                                    <div class="relative" x-data="{ pwShow: false }">
                                        <input type="password" :type="pwShow ? 'text' : 'password'" name="new_password_confirmation" placeholder="أعد كتابة كلمة المرور الجديدة" class="w-full bg-slate-50 border-0 rounded-2xl py-5 pl-5 pr-14 text-slate-700 font-bold focus:ring-2 focus:ring-gold-500">
                                        <button type="button" @click="pwShow = !pwShow" tabindex="-1" class="absolute inset-y-0 right-4 flex items-center text-slate-300 hover:text-gold-600 transition-colors">
                                            <svg x-show="!pwShow" x-transition:enter="transition duration-500 [transition-timing-function:cubic-bezier(.68,-0.55,.27,1.55)]" x-transition:enter-start="opacity-0 scale-0 rotate-180" x-transition:enter-end="opacity-100 scale-100 rotate-0" class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"></path>
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"></path>
