        ...
        <div class="overflow-y-auto flex-1">
            <template x-for="community in communities" :key="community.id">
                <button @click="selectCommunity(community)"
                    ...
                    <div class="w-12 h-12 bg-gradient-to-r from-gold-500 to-gold-600 rounded-2xl flex items-center justify-center text-white text-xl shadow-lg shrink-0">
                        <span x-text="community.icon"></span>
                    </div>
            ...
            <div class="h-full flex flex-col">
                ...
                <div class="p-4 border-b border-slate-100/50 bg-white/70 backdrop-blur flex items-center justify-between gap-3">
                    <div class="flex items-center gap-3 text-right min-w-0">
                        ...
                        <div class="w-10 h-10 bg-gold-100 rounded-2xl flex items-center justify-center text-lg shrink-0" x-text="selectedCommunity.icon"></div>
                        <div class="min-w-0">
                ...
                <div id="community-messages" class="flex-1 overflow-y-auto p-6 space-y-4 bg-slate-50/30">
                    <template x-for="msg in messages" :key="msg.id">
                        <div class="group/msg flex gap-3 items-start" :class="msg.sender_id === currentUserId ? 'flex-row-reverse' : ''">
                            <div class="w-9 h-9 rounded-xl flex items-center justify-center text-white text-[11px] font-black shrink-0"
                            ...
                            {{-- أدوات الإدارة --}}
                            <div x-show="isAdmin && !msg.is_removed" class="opacity-0 group-hover/msg:opacity-100 transition-all flex items-center gap-1 shrink-0">
