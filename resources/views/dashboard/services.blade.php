...
<div class="bg-slate-50 min-h-screen py-12 px-4 md:px-10" dir="rtl">
    <div class="max-w-6xl mx-auto">
        ...
        <div class="text-center mb-16">
            <h1 class="text-4xl font-black text-indigo-600 mb-4">خدماتنا</h1>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mb-24">
            ...
            <div class="bg-white rounded-[3rem] p-10 shadow-2xl shadow-indigo-100 border-2 border-indigo-500 flex flex-col items-center relative transform md:-translate-y-4">
                ...
                <button class="w-full py-4 bg-indigo-600 text-white rounded-2xl font-black hover:bg-indigo-700 transition shadow-lg shadow-indigo-200 mt-auto">ابدأ الآن مجاناً</button>
        ...
        <div class="bg-indigo-600 rounded-[3rem] p-10 text-center text-white relative overflow-hidden">
            <div class="relative z-10">
                ...
                <p class="text-indigo-100 font-bold mb-8">نحن هنا لمساعدتك، جميع خدماتنا متاحة مجاناً حالياً</p>
                <div class="flex flex-col md:flex-row justify-center gap-12">
                    <div class="flex flex-col items-center gap-2">
                        <span class="text-2xl">🎉</span>
                        <span class="font-black">وصول مجاني كامل</span>
                        <p class="text-[10px] text-indigo-200">لفترة محدودة</p>
                    </div>
                    <div class="flex flex-col items-center gap-2">
                        <span class="text-2xl">🎧</span>
